...
if (url.searchParams.get('sayangkuu') != null) {
  sender = url.searchParams.get('hiii yang aku mau alay dikit:v');
} else {
  sender = "Lzzzz";
}
      ...
      Swal.fire("Awasss yaaa kalooo boong", "", "error").then(function () {
        ...
        const {
          ...
          const pertanyaan = Swal.fire({
            title: `${aswil} kamuu sayang ga sama ${Lzz}?`,
            showDenyButton: true,
            ...
            if (result.isConfirmed) {
              Swal.fire(`${lzzz} juga sayang banget sama ${aswill}`).then(function () {
                Swal.fire({
                  ...
                  val = e.value
                  Swal.fire(`Makasih banget ya yang udah sayang sama ${akuu} ${val}%`).then(function () {
                    Swal.fire({
                      title: `Sekarang ${kamu} kangen ga sama ${lz}?`,
                      showDenyButton: true,
                      showCancelButton: false,
